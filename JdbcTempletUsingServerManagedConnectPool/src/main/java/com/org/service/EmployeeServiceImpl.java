...
public class EmployeeServiceImpl implements EmployeeService {
	 ...
	 * 
	 * StringBuffer sb = new StringBuffer("("); for(int i=0;i<job.length;++i) {
	 * if(i==job.length-1) { sb.append("'"+job[i]+"')"); } else {
	 * sb.append("'"+job[i]+"'"+","); }
	 * 
	 * String condition=sb.toString(); System.out.println(condition); } }
	 */
